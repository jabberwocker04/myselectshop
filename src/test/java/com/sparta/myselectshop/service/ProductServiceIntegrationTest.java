...
@TestInstance(TestInstance.Lifecycle.PER_CLASS) // 테스트 인스턴스의 생성 단위를 클래스로 변경합니다. <- 공유하지 않던 필드들(ProductService 등)을 공유할 수 있게 됌
...
//    TestInstance... 어노테이션을 사용하면서 위의 필드들을 서로 공유하게 됌.
